              ...
              >
                ...
                <SwiperSlide>
                  <div className="flex flex-col  lg:flex-row  w-full items-stretch gap-4 lg:gap-4">
                    <div className="w-full lg:w-1/2  h-[350px] bg-[#FF7900]  py-6 px-4 lg:py-8  lg:pl-10 lg:pr-12 flex flex-col justify-between">
                      <p className=" font-[Inter] font-normal leading-[26px] md:leading-[28px] text-[18px] md:text-[20px] text-[#101010]">
                        ...
                        Il aide à démontrer la mise en page et le design d'une
                        page avant que le texte réel ne soit disponible.
                        Remplacez-le par du contenu réel une fois prêt.
                      </p>
